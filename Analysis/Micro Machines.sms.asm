...
+:dec a
  jr nz, +
  call LABEL_82DF_MenuIndex1_Initialise
  jp ++
+:dec a
  jr nz, +
...
+:dec a
  jr nz, +
  call LABEL_866C_Menu3_Initialise
  jp ++
+:dec a
  jr nz, +
  call LABEL_8A38_Menu4_Initialise
  jp ++
+:dec a
  jr nz, ++
...
LABEL_82DF_MenuIndex1_Initialise:
...
+:
  jp LABEL_84AA_Menu5_Initialise
